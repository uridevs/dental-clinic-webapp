...
exports.validarCrearPaciente = [
    ...
    body('password').isStrongPassword().withMessage('La contraseña no es suficientemente segura, debe contener al menos 8 caracteres, una letra mayúscula, una letra minúscula, un número y un símbolo'),
    (req, res, next) => {
...
exports.validarActualizarPaciente = [

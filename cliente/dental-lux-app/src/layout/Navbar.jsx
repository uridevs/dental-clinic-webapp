        ...
        <div className="container">
          ...
          >
            <ul className="navbar-nav justify-content-between me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item ps-4 pe-4 border-right">
                <a className="nav-link text-dark p-0" href="#about-us">Grupo Dental Luxe</a>
              </li>
              <li className="nav-item ps-4 pe-4 border-right">
              ...
              <li className="nav-item ps-4 pe-4 border-right">
                <a className="nav-link text-dark p-0" href="#our-team">Equipo</a>
              </li>
              <li className="nav-item ps-4 pe-4 border-right">
                <a className="nav-link text-dark p-0" href="#testimonial">Testimonios</a>
              </li>
              <li className="nav-item ps-4 pe-4 border-right">
                <a className="nav-link text-dark p-0" href="#faqs">FAQ</a>
              </li>
              <li className="nav-item ps-4 pe-4 border-right">

    ...
    return (
        <Layout>
            <nav className="sb-topnav navbar navbar-expand navbar-primary bg-primary">
                <a className="navbar-brand ps-3" href="index.html">Dental Luxe APP</a>
                <button className="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i className="fas fa-bars"></i></button>
                <form className="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                    <div className="input-group">
                        <input className="form-control" type="text" placeholder="Buscar..." aria-label="Search" aria-describedby="btnNavbarSearch" />
            ...
            <main>
                <div className="container-fluid px-4">
                    ...
                    <ol className="breadcrumb mb-4">
                        <li className="breadcrumb-item active">Bienvenido [Patient Name]</li>
                    </ol>
                    <div className="row">
                        <div className="col-xl-6">
                            <div className="card mb-4">
                                ...
                                <div className="card-body">
                                    <p><strong>Nombre:</strong> [Patient's Name]</p>
                                    <p><strong>Email:</strong> [Patient's Email]</p>
                                    <p><strong>Teléfono:</strong> [Patient's Phone]</p>
        ...
        <footer className="py-4 bg-light mt-auto">
            <div className="container-fluid px-4">
                <div className="d-flex align-items-center justify-content-between small">
                    <div className="text-muted">Copyright &copy; Dental Luxe 2024</div>
                    <div>
